            ...
            <div>
               ...
               <nav className='navbar navbar-expand-lg navbar-light lg-light'>
                  <ul className='navbar-nav mr-auto'>
                     <li><link to={'/Router/'} className='nav-link'>Home</link></li>
                     <li><link to={'/Router/contact'} className='nav-link'>Contact</link></li>
                     <li><link to={'/Router/about'} className='nav-link'>About</link></li>
                  </ul>
               </nav>
               <hr/>
               <Switch>
