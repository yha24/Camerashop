		...
		    componentDidMount(){	// componentDidMount() để gọi API về																						
		...
		    onChange = (event) =>{		// khai báo 2 biến name và value																					
		...
		      }																							
		      if (type === 'file') {	// type lấy từ target(name) để xử lí    																						
		        value = this.image.value.replace( /C:\\fakepath\\/i, "/images/" );																							
		      }																							
																									
		      this.setState({ //					
                    [name] : value,		// name và value đại diện cho tất cả các name và value ô input																				
		      });																							
		    }																							
		...
		    render() {																							
		      var { id, name, price, image , name_category, colormaterial																							
		        , expiry_date, origin, description, tinhtranghang} = this.state;																							
		    return (																							
		            																							
		        <React.Fragment>																							
